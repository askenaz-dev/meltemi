...
- [ ] 1.1 `docs/ux/design-system.md`: tokens desde brand V2 (tipografía, color, espaciado, densidad) + regla transversal símbolo+palabra _(design D6)_
...
- [ ] 5.1 `proto/`: método aditivo `worktree/apply-edit` + tipos + schema _(Req edit-surface: Trazabilidad de ediciones humanas; design D5)_
