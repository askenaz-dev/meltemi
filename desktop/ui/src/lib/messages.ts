...
const es = {
  ...
  "fleet.subscriptions": "{n} suscripciones",
  "fleet.subscriptions.one": "1 suscripción",
  "fleet.subscription.of": "suscripción de {agent}",
  "fleet.subscription.orphan": "suscripción de {agent} — ese agente no está en el catálogo",
  ...
  "sessions.tabs": "Sesiones abiertas",
  "sessions.tabs.list": "Lista",
  "sessions.tabs.close": "Cerrar la pestaña",
  "tabs.scrollLeft": "Ver las pestañas anteriores",
  "tabs.group.menu": "Acciones de la pestaña",
  "tabs.group.new": "Nuevo grupo",
  "tabs.group.newPlaceholder": "nombre del grupo",
  "tabs.group.join": "Mover a «{name}»",
  "tabs.group.leave": "Sacar del grupo",
  "tabs.group.collapsed": "{name} ({n})",
  "tabs.scrollRight": "Ver las pestañas siguientes",
  "sessions.tabs.unread": "{n} sin leer",
  "sessions.tabs.gone": "sesión",
  "sessions.tabs.full": "Caben {n} sesiones abiertas a la vez. Cierra una pestaña para abrir otra.",
  ...
  "nav.bucket.decision": "Esperan tu decisión",
  "nav.bucket.instruction": "Listas para tu instrucción",
  "nav.bucket.working": "Trabajando",
  "nav.bucket.stopped": "Detenidas",
  "nav.bucket.seeAll": "Ver las {n}",
  "nav.bucket.open": "abierta en una pestaña",
  "nav.open.title": "Abiertas ({n})",
  ...
  "home.agent.seeFleet": "Abrir la Flota",
  "home.agent.detected": "{n} detectados",
  ...
  "harness.none": "sin harness configurado para este agente",
  "harness.globalOnly": "sin proyecto abierto: solo se muestra tu harness global",
  "harness.readOnly": "solo lectura: las piezas viven en archivos",
  "harness.covered": "pisa a la de {layer}",
  "harness.unknownAgent":
    "identificador que el catálogo no conoce: nada se leyó ni se proyectó",
  "harness.layer.user": "global",
  "harness.layer.user_agent": "global por agente",
  "harness.layer.project": "proyecto",
  "harness.layer.project_agent": "proyecto por agente",
...
const en: Record<MessageKey, string> = {
  ...
  "fleet.subscriptions": "{n} subscriptions",
  "fleet.subscriptions.one": "1 subscription",
  "fleet.subscription.of": "subscription of {agent}",
  "fleet.subscription.orphan": "subscription of {agent} — that agent is not in the catalog",
  ...
  "sessions.tabs": "Open sessions",
  "sessions.tabs.list": "List",
  "sessions.tabs.close": "Close the tab",
  "tabs.scrollLeft": "Show the previous tabs",
  "tabs.group.menu": "Tab actions",
  "tabs.group.new": "New group",
  "tabs.group.newPlaceholder": "group name",
  "tabs.group.join": "Move to “{name}”",
  "tabs.group.leave": "Remove from group",
  "tabs.group.collapsed": "{name} ({n})",
  "tabs.scrollRight": "Show the next tabs",
  "sessions.tabs.unread": "{n} unread",
  "sessions.tabs.gone": "session",
  "sessions.tabs.full": "{n} sessions fit open at once. Close a tab to open another.",
  ...
  "nav.bucket.decision": "Waiting on your decision",
  "nav.bucket.instruction": "Ready for your instruction",
  "nav.bucket.working": "Working",
  "nav.bucket.stopped": "Stopped",
  "nav.bucket.seeAll": "See all {n}",
  "nav.bucket.open": "open in a tab",
  "nav.open.title": "Open ({n})",
  ...
  "home.agent.seeFleet": "Open the Fleet",
  "home.agent.detected": "{n} detected",
  ...
  "harness.title": "Harness",
  "harness.none": "no harness is configured for this agent",
  "harness.globalOnly": "no project open: only your global harness is shown",
  "harness.readOnly": "read only: the pieces live in files",
  "harness.covered": "covers the one from {layer}",
  "harness.unknownAgent":
    "an identifier the catalog does not know: nothing was read or projected",
  "harness.layer.user": "global",
  "harness.layer.user_agent": "global per agent",
  "harness.layer.project": "project",
  "harness.layer.project_agent": "project per agent",
  "palette.m.harness.effective":
